Django Rest Framework for Watershed Boundary Dataset
===================================================

This repo provides and API for the Watershed Boundary Dataset.

Note: This README is template ... I still need to write it

Support for Angular 5 and Django<2 is not actively developed - use
